...
% Control panel
app.ControlPanel = uipanel(app.MainGrid, 'BorderType', 'none');
app.ControlPanel.Layout.Row = 1;
app.ControlPanel.Layout.Column = 1;
app.ControlGrid = uigridlayout(app.ControlPanel, [1 11], ...
    'RowHeight', {'fit'}, ...
    'ColumnWidth', {'fit','fit','fit','fit','fit','fit','fit','fit','1x','fit','fit'}, ...
    'ColumnSpacing', 10, ...
    'Padding', [6 14 6 14]);

subjectLabel = uilabel(app.ControlGrid, 'Text', 'Subject', ...
...
app.SubjectDropdown.Layout.Row = 1;
app.SubjectDropdown.Layout.Column = 2;

trialLabel = uilabel(app.ControlGrid, 'Text', 'Trial', ...
    'HorizontalAlignment', 'left', 'FontWeight', 'bold');
trialLabel.Layout.Row = 1;
trialLabel.Layout.Column = 3;
app.TrialDropdown = uidropdown(app.ControlGrid, ...
    'Items', {}, ...
    'ItemsData', {}, ...
    'ValueChangedFcn', @(src, evt)onTrialChanged(evt.Value));
app.TrialDropdown.Layout.Row = 1;
app.TrialDropdown.Layout.Column = 4;

viewLabel = uilabel(app.ControlGrid, 'Text', 'View', ...
    'HorizontalAlignment', 'left', 'FontWeight', 'bold');
viewLabel.Layout.Row = 1;
viewLabel.Layout.Column = 5;
...
app.ViewDropdown.Layout.Column = 6;

stepLabel = uilabel(app.ControlGrid, 'Text', 'Step', ...
    'HorizontalAlignment', 'left', 'FontWeight', 'bold');
stepLabel.Layout.Row = 1;
stepLabel.Layout.Column = 7;
...
app.StepDropdown.Layout.Row = 1;
app.StepDropdown.Layout.Column = 8;
...
app.MessageLabel.Layout.Column = 9;
...
app.ExportButton.Layout.Column = 11;
...
app.VisualGrid = uigridlayout(app.MainGrid, [1 2], ...
    ...
    'Padding', [10 10 10 10], ...
    'RowSpacing', 0);
app.VisualGrid.Layout.Row = 2;
app.VisualGrid.Layout.Column = 1;
